if ("geolocation" in navigator) {
  ...
  navigator.geolocation.getCurrentPosition(async (position) => {
    ...
    if (false) {
      ...
      document.getElementById("aq_units").textContent = airData.unit
        ? airData.unit
        : "";
      document.getElementById("last_updated").textContent = airData.lastUpdated
        ? airData.lastUpdated.substring(0, 10)
        : "Never";
